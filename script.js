    ...
    value: function start() {
      ...
      if (!this.timer) {
        ...
        this.timer = setInterval(function () {
          var stopTime = Date.now(); //get current time

          var timePassedInMilliSeconds = stopTime - startTime + _this2.state.timePassedInMilliSeconds; // work out the elapsed time

          _this2.setState({
            timePassedInMilliSeconds: timePassedInMilliSeconds //store the total elapsed time( current + previous ) here
          });
